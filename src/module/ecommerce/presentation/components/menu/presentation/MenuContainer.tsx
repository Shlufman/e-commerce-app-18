...
import {menuItems, tempMenuItems, TypeMenuItemDTO} from '../../../../../../general/constants/constants';
...
const MenuContainer: React.FC = () => {
    ...
    const handleOnHoverAddMenu: TFHandleOnHoverAddMenu = (item: TCMenuItem) => {
        ...
        setSubMenuItems(prev => {
            ...
            let newSubMenu: Array<TCMenuItem> = newState[item.level].subMenu?.map(el => {
                let newElem;
    ...
    return (<div className={style.container} >
            <div className={style.menuBox}>
                {subMenuItems[0] && <RFCMenuItem key={subMenuItems[0].id}
                                                 item={subMenuItems[0]}
            ...
            <div className={style.ghostBackDrop+(subMenuItems.length===1?style.ghostBackDropHidden:'')} onClick={handleOnClickGHostBackDrop}>
